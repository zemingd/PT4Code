...
def main():
    ...
    args.eval_data_file = f"{root_path}/datasets/{model}/{task}/{args.data_type}.jsonl"
    if args.data_type == "train":
        if not os.path.isdir(f"{adv_root_path}/datasets/{model}/{task}"):
            os.makedirs(f"{adv_root_path}/datasets/{model}/{task}")
        args.store_path = f"{adv_root_path}/datasets/{model}/{task}/{args.data_type}_subs_{args.index[0]}_{args.index[1]}.jsonl"
    else:
        args.store_path = f"{root_path}/datasets/{model}/{task}/{args.data_type}_subs_{args.index[0]}_{args.index[1]}.jsonl"
