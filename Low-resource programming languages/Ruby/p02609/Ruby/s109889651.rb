...
INF.times do |i|
  tmp = plus_contribution.first * 2 % plus if plus != 0
  # if tmp == plus_last
  #   break
  # else
...
INF.times do |i|
  tmp = minus_contribution.first * 2 % minus if minus != 0
  # if tmp == minus_last
  #   break
  # else
...
x.each_char.with_index do |c, i|
  next if c == '0'
  plus_default += plus_contribution[i] if plus_contribution[i]
  minus_default += minus_contribution[i] if minus_contribution[i]
end
...
(n - 1).downto(0) do |i|
  if x[i] == '0'
    ...
    tmp_mod += plus_contribution[i] if plus_contribution[i]
    ...
    tmp_mod -= minus_contribution[i] if minus_contribution[i]
