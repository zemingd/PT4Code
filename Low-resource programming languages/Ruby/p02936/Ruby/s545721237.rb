if !ENV['RUBY_THREAD_VM_STACK_SIZE']
    ...
    exec({'RUBY_THREAD_VM_STACK_SIZE'=>'500000000'},RUBY,$0)
end

# require 'pp'
class Node
    attr_accessor :children, :cnt, :sub_root, :is_sub_root, :parent
    attr_reader :idx
    def initialize(idx)
        @idx = idx
        @children = []
    ...
    def calc_cnt
        return @cnt if @parent.nil?
        return @calculated_cnt unless @calculated_cnt.nil?
        @calculated_cnt = @parent.calc_cnt + @cnt
    end
end
