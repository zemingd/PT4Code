class Dice
  ...
  def ==(other)
    c1 = @n.uniq.map{|e| [e, @n.count(e)]}.sort{|a,b|if a[1]==b[1] then a[0]<=>b[0] else a[1]<=>b[1] end}
    c2 = other.n.uniq.map{|e| [e, @n.count(e)]}.sort{|a,b|if a[1]==b[1] then a[0]<=>b[0] else a[1]<=>b[1] end}
