...
//   $ bundle -pkg main -prefix   -dst github.com/mpppk/atcoder/abc123/b github.com/mpppk/atcoder/abc123/b
...
func solve(input *lib_Input) int {
	...
	dishOrders := lib_IntPermutation(dishes, 5)
...
func lib_Combination(n, r int) (int, error) {
	...
	nFac, err := lib_Factorial(n)
	if err != nil {
		return 0, fmt.Errorf("too large n: %s", err)
	}
	nrFac, err := lib_Factorial(n - r)
	if err != nil {
