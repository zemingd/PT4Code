...
func main() {
	...
	a3 := next.Int()
	ans := inf
	ans = min(ans, abs(a1-a2)+abs(a1-a3))
	ans = min(ans, abs(a1-a2)+abs(a2-a3))
	ans = min(ans, abs(a2-a3)+abs(a2-a1))
	ans = min(ans, abs(a2-a3)+abs(a3-a1))
	ans = min(ans, abs(a3-a1)+abs(a2-a3))
	ans = min(ans, abs(a3-a1)+abs(a2-a1))
	fmt.Println(ans)
}
