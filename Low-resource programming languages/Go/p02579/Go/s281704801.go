...
// 	fmt.Println(field)
	...
	for len(startQue) > 0 {
		...
		for len(que) > 0 {
			...
			//right2
			if value.w < w-2 && field[value.h][value.w+2] != "#" && field[value.h][value.w+2] == "#"{
				startQue = append(startQue, me{value.h, value.w + 2, value.count + 1, "right2"})
			}
			//down2
			if value.h < h-2 && field[value.h+2][value.w] != "#"  && field[value.h+2][value.w] == "#"{
			...
			if value.w-1 > 0 && value.h-1 > 0 && field[value.h-2][value.w-2] != "#" && field[value.h][value.w-1] == "#" && field[value.h-1][value.w] == "#"{
			...
			if value.w < w-2 && value.h-1 > 0 && field[value.h-2][value.w+2] != "#" && field[value.h][value.w+1] == "#" && field[value.h-1][value.w] == "#"{
			...
			if value.w-1 > 0 && value.h < h-2 && field[value.h+2][value.w-2] != "#" && field[value.h][value.w-1] == "#" && field[value.h+1][value.w] == "#"{
			...
			if value.w < w-2 && value.h < h-2 && field[value.h+2][value.w+2] != "#" && field[value.h][value.w+1] == "#" && field[value.h+1][value.w] == "#"{
