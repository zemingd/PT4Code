...
func main() {
	...
	for len(queue) > 0 {
		...
		for _, p := range []*P{
			...
			if filled[fmt.Sprintf("%d/%d", p.x, p.y)] {
				continue
			}
			if D[p.y][p.x] == "." {
				...
				for _, p := range []*P{
					{
						x: q.x + 2, y: q.y - 2, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 2, y: q.y - 1, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 2, y: q.y, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 2, y: q.y + 1, score: p.score, times: p.times + 1,
					},
					...
					{
						x: q.x + 1, y: q.y - 2, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 1, y: q.y - 1, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 1, y: q.y, score: p.score, times: p.times + 1,
					},
					{
						x: q.x + 1, y: q.y + 1, score: p.score, times: p.times + 1,
					},
					...
					{
						x: q.x, y: q.y - 2, score: p.score, times: p.times + 1,
					},
					{
						x: q.x, y: q.y - 1, score: p.score, times: p.times + 1,
					},
					{
						x: q.x, y: q.y, score: p.score, times: p.times + 1,
					},
					{
						x: q.x, y: q.y + 1, score: p.score, times: p.times + 1,
					},
