...
func solution3aSub(d int, t []int, S int, score int, last []int) ([]int, int, int, []int) {
	t = append(t, 0)
	bestNewS := -1
	bestNewScore := -1
	bestContestType := -1
	...
	t[len(t)-1] = bestContestType
	last[bestContestType] = d
...
func solution3a() []int {
	...
	for d := 0; d < D; d++ {
		t, S, score, last = solution3aSub(d, t, S, score, last)
	}
	return t
}
