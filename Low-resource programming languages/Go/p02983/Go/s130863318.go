...
func main() {
	...
	// zero case
	// minval case
	var cases []int64 = make([]int64, 2019)
	ini(cases, INF)
	for i, j := L, 0; i < L+2019; i, j = i+1, j+1 {
		cases[j] = i % 2019
		if i == R {
			break
		}
	}
	fmt.Println(solve(cases) % 2019)
}
