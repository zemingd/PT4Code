...
func main() {
	...
	// for i := 1; i <= N; i++ {
	// 	// Logf("%v %v\n", math.Floor(float64(A*i)/float64(B)), float64(A)*math.Floor(float64(i)/float64(B)))
	// 	// ans = intMax(ans, int(math.Floor(float64(A*i)/float64(B))-float64(A)*math.Floor(float64(i)/float64(B))))
	// 	ans = intMax(ans, A*i/B-A*(i/B))
	// 	Logf("%v, %v\n", i, ans)
	// 	// Logf("%v %v\n", math.Floor(float64(A*i)/float64(B)), float64(A)*math.Floor(float64(i)/float64(B)))
	// }
	fmt.Printf("%v\n", ans)
