...
//   $ bundle -pkg main -prefix   -dst github.com/mpppk/atcoder/abc079/c github.com/mpppk/atcoder/abc079/c
...
func solve(input *lib_Input) string {
	...
	// stringをdigitsに変換するやつを書く
	ticketNumbers := lib_MustStringToIntSlice(ticketStrs)
	//ticketNumbers := lib_ToDigitSliceInt(ticket)
