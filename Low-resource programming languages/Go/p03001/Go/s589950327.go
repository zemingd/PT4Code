...
func main() {
	...
	if float64(y) == float64(h)/float64(w)*float64(x) && float64(y) == float64(h)-float64(h/w*x) {
		fmt.Println(float64(w*h)/float64(2), 1)
		return
	}
	if float64(y) == float64(h)/float64(w)*float64(x) {
		fmt.Println(float64(w*h)/float64(2), 0)
		return
	}
	if float64(y) == float64(h)-float64(h)/float64(w)*float64(x) {
		fmt.Println(float64(w*h)/float64(2), 0)
		return
	}
